...
**L38 · In the DSH browser loader, a wrong dependency name breaks the whole UI, not the plugin.**
...
**L39 · `$pid` is reserved and read-only, and PowerShell matches it case-insensitively.**
