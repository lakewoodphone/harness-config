...
**L220 · 2026-09-14 · A monitor must not need the thing it monitors in order to report that thing's
failure — and "needs admin" is a claim about the fix, not about the problem.**
...
**L221 · 2026-09-14 · Do not judge a price model against a market the business does not buy in.**
