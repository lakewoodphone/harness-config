...
**D55 · 2026-09-14 · Being the lawyer meant reading the contracts, and the contract killed the cheapest vendor.**
...
**D56 · 2026-09-14 · Two independent studies disagreed about whether COPPA applies, and the reconciliation — not either finding — is the decision.**
...
**D57 · 2026-09-14 · The shipped defaults are the legal posture, so they are pinned by a test.**
...
**D58 · 2026-09-14 · Retention starts when we hold the data, not when the device says the moment was.**
...
**D59 · 2026-09-14 · A portal may push a profile only as one of two named intents, never as a raw profile picker.**
...
**D60 · 2026-09-14 · The API owns timezone correctness; consumers are never asked to guess.**
...
**D61 · 2026-09-14 · Any read that can fail to determine returns that failure as a field, not as an empty list.**
...
**D62 · 2026-09-14 · A `retired` device is exempt from staleness in every surface, and the monitor is the authority for that rule.**
...
**D63 · 2026-09-14 · The computer-finder questionnaire is a customer-facing feature, so it is gated by `customerProcedure` — and its budget bands are the four the owner decided, not the three the code had.**
...
**D64 · 2026-09-14 · Enum types in backend services are derived from the generated model, never imported by name.**
...
**D59 · 2026-09-14 · Consent is enforced at every door, and I only found the other three by going to look.**
...
**D60 · 2026-09-14 · I audited my own parent notice against the code and three sentences were untrue.**
...
**D61 · 2026-09-14 · Archiving is right for our own audit records and wrong for a record about a child.**
...
**D62 · 2026-09-14 · The scrub belongs on the phone, and the pixel test found the bug the geometry test could not.**
...
**D63 · 2026-09-14 · A control implemented on one storage backend is a control that disappears on the other.**
...
**D64 · 2026-09-14 · Refreshing a sign-off snapshot is an attestation, so it has to say what it actually is.**
...
**D65 · 2026-09-14 · The owner's answer on the product's promise: no numbers until measured, and make the words carry it (his words: option 1, "but use 3 to make it sound good").**
...
**D66 · 2026-09-14 · Correction to the round-6 verification: one of the two "regressions that are mine" was environmental, and the method that said otherwise was flawed.**
