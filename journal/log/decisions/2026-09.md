...
---
<!-- e:decisions|D72|2026-09-14|SECRATARY|open -->
**D72 · 2026-09-14 · P67 was never an entry: the pain is P66, and the dangling-ref warning that says so is correct.**

## The id allocation, recorded because two recent entries cite the wrong one

When I filed the composer pain on 2026-09-14 I was allocated **P66** (the tool assigns the id
at append time) but had written "P67" into the body of both **P66** and **H77**. `journal.py
check` now reports `dangling ref P67` twice, at `log/pain/2026-09.md:1681` and
`log/handoff/2026-09.2.md:1972`. Those references are inert.

**Decision: do not rewrite the entries.** The record is append-only; the rule (H1/L1) is that a
wrong entry is corrected by a new one citing it, never edited to look better in hindsight. So:

- **P67 does not exist and must not be created.** A future session looking for "the composer
 pain" wants **P66**.
- The dangling-ref warnings for P67 are the correct state of the record, not a defect to
 silence — the same reasoning as the long-standing `L75` INFO the journal deliberately leaves
 visible.

**The process lesson:** write the body *after* the tool returns the id when the body needs to
cite itself. For every other entry the id can stay out of the prose — this is the second time
in one month an entry was written citing a number it had not been given yet.

---
<!-- e:decisions|D73|2026-09-14|imported|open -->
**D73 · 2026-09-14 · The computer-finder questionnaire is a customer-facing feature, so it is gated by `customerProcedure` — and its budget bands are the four the owner decided, not the three the code had.**
...
**D74 · 2026-09-14 · Enum types in backend services are derived from the generated model, never imported by name.**
...
**D75 · 2026-09-14 · Consent is enforced at every door, and I only found the other three by going to look.**
...
**D76 · 2026-09-14 · I audited my own parent notice against the code and three sentences were untrue.**
...
**D77 · 2026-09-14 · Archiving is right for our own audit records and wrong for a record about a child.**
...
**D78 · 2026-09-14 · The scrub belongs on the phone, and the pixel test found the bug the geometry test could not.**
...
**D79 · 2026-09-14 · A control implemented on one storage backend is a control that disappears on the other.**
...
**D80 · 2026-09-14 · Refreshing a sign-off snapshot is an attestation, so it has to say what it actually is.**
...
**D81 · 2026-09-14 · The owner's answer on the product's promise: no numbers until measured, and make the words carry it (his words: option 1, "but use 3 to make it sound good").**
...
---
<!-- e:decisions|D82|2026-09-14|imported|open -->
**D82 · 2026-09-14 · Correction to the round-6 verification: one of the two "regressions that are mine" was environmental, and the method that said otherwise was flawed.**
