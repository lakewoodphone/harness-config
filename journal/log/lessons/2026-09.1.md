...
<!-- e:lessons|L34b||-|open -->
**L34b · A log file that the child process owns cannot be cleared by the parent**
...
<!-- e:lessons|L36b||-|open -->
**L36b · A measurement that returns HTTP 200 is not a measurement that did work**
...
<!-- e:lessons|L39b||-|done -->
**L39b · Read the extension seam before deciding whether a change is a patch or a plugin**
...
<!-- e:lessons|L40b||-|open -->
**L40b · A generated file must be generated from the tested file, or the tests are theatre**
...
<!-- e:lessons|L51b||-|open -->
**L51b · A tracker row saying "waiting on the owner" is a claim, not evidence — check the decisions log before asking**
...
<!-- e:lessons|L52b||-|open -->
**L52b · A number in an internal document is a claim, not a measurement — and an unmeasurable band is a warning sign**
...
<!-- e:lessons|L53b||-|open -->
**L53b · Read the authoritative deploy doc before escalating an infrastructure blocker**
...
<!-- e:lessons|L146b||-|open -->
**L146b · 2026-09-14 · Read the layout mechanism before you style it**
...
<!-- e:lessons|L147b||-|open -->
**L147b · 2026-09-14 · A transformed ancestor owns its fixed descendants**
...
<!-- e:lessons|L148b||-|open -->
**L148b · 2026-09-11 · Editing a Python file does not reach a running scheduler — and the proof it took is behavioural, not a restart banner**
...
<!-- e:lessons|L148c||-|open -->
**L148c · 2026-09-14 · Before hiding a control, verify it is not the only one**
...
<!-- e:lessons|L151b||-|open -->
**L151b · 2026-09-14 · A booting service is not a dead one — and a dead one is not a plugin's fault**
...
<!-- e:lessons|L152b||-|open -->
**L152b · 2026-09-14 · The harness can serve documents and still refuse its API, and the refusal is not from any plugin**
...
<!-- e:lessons|L154b||-|open -->
**L154b · 2026-09-12 01:05 · A per-item verdict cached against a group key is not a cache bug — it is an unverified allow**
...
<!-- e:lessons|L155b||-|open -->
**L155b · 2026-09-12 01:05 · A record with no content yet is pending, not stale**
...
<!-- e:lessons|L157b||-|open -->
**L157b · 2026-09-12 01:05 · An entry number is not a key: two machines mint the same next number, and the log merges by union**
...
<!-- e:lessons|L158b||-|open -->
**L158b · 2026-09-11 · A second copy of a thing is not a second reading of it**
...
<!-- e:lessons|L160||-|open -->
**L160 · 2026-09-11 · Fail-closed cursors make a silent outage recoverable — which is not the same as noticing it**
...
<!-- e:lessons|L162||-|open -->
**L162 · 2026-09-11 · Working production code can exist outside version control, and only the *deployment host* knows it does.** The Shabbat/Tov split that fired at 18:46:53 tonight existed**
...
<!-- e:lessons|L163||-|open -->
**L163 · 2026-09-11 · Measure the size of a lie before you fix it — and beware a metric that counts the *failure handler* as success**
...
<!-- e:lessons|L164||-|open -->
**L164 · 2026-09-11 · A structural guard must check *control flow*, not *text presence***
...
<!-- e:lessons|L165||-|open -->
**L165 · 2026-09-11 · A blunt suppression fix outlives its incident, and the silence it creates is invisible because it looks like calm**
...
<!-- e:lessons|L166||-|open -->
**L166 · 2026-09-11 · Distinguish the gate from the transport before naming a cause**
...
<!-- e:lessons|L168||-|open -->
**L168 · 2026-09-11/13 · Do not confuse "I have been working for a while" with "no time has passed"**
...
<!-- e:lessons|L169b||-|open -->
**L169b · 2026-09-14 04:05 UTC · `ipaddress.is_private` is not "is a local LAN address"**
...
<!-- e:lessons|L170||-|open -->
**L170 · 2026-09-14 · Two tokenizers, because one index cannot be good at both prose and code**
...
<!-- e:lessons|L170b||-|open -->
**L170b · 2026-09-14 04:05 UTC · A one-packet probe of a sleeping peer manufactures false negatives — test the cold call, not the steady state**
...
<!-- e:lessons|L171||-|open -->
**L171 · 2026-09-14 · A Techloq-class filter serves its block page with a SUCCESS status code, so a status check reads a block as a pass**
...
<!-- e:lessons|L171b||-|open -->
**L171b · 2026-09-14 · Index the same text twice and you pay twice — choose ONE expensive index**
...
<!-- e:lessons|L172b||-|done -->
**L172b · 2026-09-14 · Index the trees you own; a backup directory is a second copy of your own index**
...
<!-- e:lessons|L172c||-|open -->
**L172c · 2026-09-14 · A TLS-intercepting filter can make a working API key look broken**
...
<!-- e:lessons|L173||-|open -->
**L173 · 2026-09-14 · `import.meta.main` silently no-ops the whole CLI on Node < 24.2 — and `node --check`, `import()`, and a clean exit code all say the code is fine**
...
<!-- e:lessons|L173b||-|open -->
**L173b · 2026-09-14 · Two parsers of the same format will disagree; find out which one is inflating before you trust the bigger number.** The first chat ingester reported **15,149 messages**
...
<!-- e:lessons|L174b||-|open -->
**L174b · 2026-09-14 · Never send an alert about a broken channel through that channel**
...
<!-- e:lessons|L175b||-|open -->
**L175b · 2026-09-14 · An instruction the owner cannot follow is a bug, not non-compliance — and a headless host cannot serve an interactive login**
...
<!-- e:lessons|L176b||-|open -->
**L176b · 2026-09-14 · `held` is a terminal state unless something explicitly drains it — so count `sent`, not `queued`**
...
<!-- e:lessons|L177b||-|retracted -->
**L177b · 2026-09-14 · A truncated result and a true absence look identical to a reader**
...
---
<!-- e:lessons|L201|2026-09-14|imported|open -->
**L201 · 2026-09-14 · Two layouts passed review and were both wrong; the screenshot found what reading could not**
...
---
<!-- e:lessons|L203|2026-09-14|imported|open -->
**L203 · 2026-09-14 · A test that exercises nothing passes for the right reason and teaches you the wrong lesson**
...
---
<!-- e:lessons|L204|2026-09-14|imported|open -->
**L204 · 2026-09-14 · Bumping a parser version is a data operation, not a metadata change**
...
---
<!-- e:lessons|L206|2026-09-14|imported|open -->
**L206 · 2026-09-14 · A timestamp with no timezone is not a timestamp; it is a guess with a format**
...
---
<!-- e:lessons|L207|2026-09-14|imported|open -->
**L207 · 2026-09-14 · The tool you measure with can be the thing that is wrong. Read raw bytes before believing a rendering**
...
---
<!-- e:lessons|L208|2026-09-14|imported|open -->
**L208 · 2026-09-14 · "It has never been asked" and "it has none" are different facts, and a UI that conflates them will tell an operator the opposite of the truth**
...
---
<!-- e:lessons|L210|2026-09-14|imported|open -->
**L210 · 2026-09-14 · A build script that reports success may not have rebuilt from the code you think**
...
---
<!-- e:lessons|L211|2026-09-14|imported|open -->
**L211 · 2026-09-14 · When the platform is blocked, build the verification path instead of waiting — and say which artifact you verified**
...
---
<!-- e:lessons|L214|2026-09-14|imported|open -->
**L214 · 2026-09-14 · A shared branch was rewritten under me; `push` printed success and nothing landed**
...
---
<!-- e:lessons|L215|2026-09-14|imported|open -->
**L215 · 2026-09-14 · An "unverified" tag is not a neutral result when it suppresses something that is true**
...
---
<!-- e:lessons|L216|2026-09-14|imported|open -->
**L216 · 2026-09-14 · Assert on the artefact that ships, not on the call that was supposed to produce it**
...
---
<!-- e:lessons|L217|2026-09-14|imported|open -->
**L217 · 2026-09-14 · A `git worktree` is not a copy of the working tree — untracked files stay behind, so it is the wrong control for environment-sensitive behaviour**
...
---
<!-- e:lessons|L221|2026-09-14|ZABZ-YOGA|open -->
**L221 · 2026-09-14 - Piping a journal body through PowerShell double-encodes it, and the write path never noticed**

**L · 2026-09-14 · Piping a journal body through PowerShell double-encodes it, and the write path never noticed**
...
1. **The tool accepted it.** `journal.py append` has no encoding assertion, so a corrupted body
 writes cleanly and `journal.py check` still reports 0 errors — `check` validates ids and
 structure, not character encoding. A future reader searching for `—` or `·` would not find
...
2. **My first repair missed the worst case.** The script's em-dash rule expected U+009D as the
 ...
 `handoff/2026-09.md`, which does not exist — the handoff shard is **split** into
...
Durable rules:
- Write journal bodies with an explicit UTF-8 path — `python -c` with `subprocess` and a binary
 stdin, or a file argument — never through a PowerShell/Windows pipe.
...
to write; idempotent — a second run reports 0).
