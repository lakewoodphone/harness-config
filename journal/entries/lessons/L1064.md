<!-- e:lessons|L1064||legacy|open -->
**L1064 · 2026-09-14 · `import.meta.main` silently no-ops the whole CLI on Node < 24.2 — and `node --check`, `import()`, and a clean exit code all say the code is fine**
...
<!-- j2 tags=legacy-import refs= sha=c3390b68b93a5328 alias_of= -->
