<!-- e:lessons|L710||legacy|open -->
**L710 · `catch (Exception)` does not catch `Error`, and that is how a `compileOnly` dependency crashes an app**
...
<!-- j2 tags=legacy-import refs= sha=4b0d039660e64599 alias_of= -->
