<!-- e:lessons|L959||legacy|open -->
**L959 · 2026-09-14 · `import.meta.main` silently no-ops the whole CLI on Node < 24.2 — and `node --check`, `import()`, and a clean exit code all say the code is fine**
...
<!-- j2 tags=legacy-import refs= sha=d771409792bf8b80 alias_of= -->
