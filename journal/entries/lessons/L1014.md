<!-- e:lessons|L1014||legacy|open -->
**L1014 · A fix verified through one entry point is not verified. Test the path the user actually takes**
...
<!-- j2 tags=legacy-import refs= sha=b1af96d02daa331c alias_of= -->
