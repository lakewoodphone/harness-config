<!-- e:lessons|L528||legacy|open -->
**L528 · A tracker row saying "waiting on the owner" is a claim, not evidence — check the decisions log before asking**
...
<!-- j2 tags=legacy-import refs= sha=2409addc941d8f0c alias_of= -->
