<!-- e:lessons|L56||legacy|open -->
**L56 · A measurement that returns HTTP 200 is not a measurement that did work**
...
<!-- j2 tags=legacy-import refs= sha=c798ef5160f7eeca alias_of= -->
