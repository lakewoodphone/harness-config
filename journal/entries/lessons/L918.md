<!-- e:lessons|L918||legacy|open -->
**L918 · `$pid` is reserved and read-only, and PowerShell matches it case-insensitively**
...
<!-- j2 tags=legacy-import refs= sha=5f6458dbf6ed9fd9 alias_of= -->
