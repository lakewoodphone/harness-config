<!-- e:lessons|L258||legacy|open -->
**L258 · The cheapest technical option can be the one the vendor forbids — read the terms before the price**
...
<!-- j2 tags=legacy-import refs= sha=0796260147afe367 alias_of= -->
