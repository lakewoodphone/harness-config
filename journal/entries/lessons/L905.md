<!-- e:lessons|L905||legacy|open -->
**L905 · A successful tool call is not a correct answer. Verify the claim, not the plumbing**
...
<!-- j2 tags=legacy-import refs= sha=6409be63db26f1e7 alias_of= -->
