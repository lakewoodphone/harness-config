<!-- e:lessons|L338||legacy|open -->
**L338 · A tracker row saying "waiting on the owner" is a claim, not evidence — check the decisions log before asking**
...
<!-- j2 tags=legacy-import refs= sha=b6fec4cfc6769766 alias_of= -->
