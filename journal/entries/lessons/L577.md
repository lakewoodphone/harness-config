<!-- e:lessons|L577||legacy|open -->
**L577 · 2026-09-14 · A Techloq-class filter serves its block page with a SUCCESS status code, so a status check reads a block as a pass**
...
<!-- j2 tags=legacy-import refs= sha=64e6d45b26a64741 alias_of= -->
