<!-- e:lessons|L624||legacy|open -->
**L624 · A script that has never run against its real target is not a script**
...
<!-- j2 tags=legacy-import refs= sha=f34b8a019ff8451f alias_of= -->
