<!-- e:lessons|L444||legacy|open -->
**L444 · A fix verified through one entry point is not verified. Test the path the user actually takes**
...
<!-- j2 tags=legacy-import refs= sha=1c2cd969f4bf0f31 alias_of= -->
