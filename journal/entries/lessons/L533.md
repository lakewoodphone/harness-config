<!-- e:lessons|L533||legacy|open -->
**L533 · The cheapest technical option can be the one the vendor forbids — read the terms before the price**
...
<!-- j2 tags=legacy-import refs= sha=cb930843fb6ec8ca alias_of= -->
