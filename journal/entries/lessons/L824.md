<!-- e:lessons|L824||legacy|open -->
**L824 · A fix verified through one entry point is not verified. Test the path the user actually takes**
...
<!-- j2 tags=legacy-import refs= sha=1b30237cd9d1dd72 alias_of= -->
