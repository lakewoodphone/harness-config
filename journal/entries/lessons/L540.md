<!-- e:lessons|L540||legacy|open -->
**L540 · When a delivered figure is disputed, find the longest matching prefix — the difference is usually formatting**
...
<!-- j2 tags=legacy-import refs= sha=095cc1b8e90bdc24 alias_of= -->
