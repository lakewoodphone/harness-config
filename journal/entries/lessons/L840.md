<!-- e:lessons|L840||legacy|open -->
**L840 · `Process.HasExited` on a detached child can block for the child's whole lifetime**
...
<!-- j2 tags=legacy-import refs= sha=d9e4f091364d1fd4 alias_of= -->
