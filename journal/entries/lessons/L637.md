<!-- e:lessons|L637||legacy|open -->
**L637 · A model's self-reported confidence is not a failure signal — never gate a fail-closed system on it**
...
<!-- j2 tags=legacy-import refs= sha=e9cfd9199b5c8809 alias_of= -->
