<!-- e:lessons|L719||legacy|open -->
**L719 · A fix verified through one entry point is not verified. Test the path the user actually takes**
...
<!-- j2 tags=legacy-import refs= sha=448e9adcd727c97d alias_of= -->
