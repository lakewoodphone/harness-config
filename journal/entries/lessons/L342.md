<!-- e:lessons|L342||legacy|open -->
**L342 · A model's self-reported confidence is not a failure signal — never gate a fail-closed system on it**
...
<!-- j2 tags=legacy-import refs= sha=3954b1fe3431273c alias_of= -->
