<!-- e:lessons|L842||legacy|open -->
**L842 · Checking one channel and escalating is not diligence — it is a guess with a citation**
...
<!-- j2 tags=legacy-import refs= sha=cad84a80fec0334f alias_of= -->
