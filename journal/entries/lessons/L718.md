<!-- e:lessons|L718||legacy|open -->
**L718 · A tracker row saying "waiting on the owner" is a claim, not evidence — check the decisions log before asking**
...
<!-- j2 tags=legacy-import refs= sha=a5eebc4db1f8da8e alias_of= -->
