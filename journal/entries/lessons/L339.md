<!-- e:lessons|L339||legacy|open -->
**L339 · A fix verified through one entry point is not verified. Test the path the user actually takes**
...
<!-- j2 tags=legacy-import refs= sha=755a8decdd018349 alias_of= -->
