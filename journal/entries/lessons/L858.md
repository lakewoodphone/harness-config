<!-- e:lessons|L858||legacy|open -->
**L858 · 2026-09-11 · Working production code can exist outside version control, and only the *deployment host* knows it does.** The Shabbat/Tov split that fired at 18:46:53 tonight existed**
...
<!-- j2 tags=legacy-import refs= sha=c7110ad132b2513a alias_of= -->
