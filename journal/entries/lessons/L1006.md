<!-- e:lessons|L1006||legacy|open -->
**L1006 · A test that passes before and after the fix has no teeth — check it against the broken revision**
...
<!-- j2 tags=legacy-import refs= sha=2115f12c30930993 alias_of= -->
