<!-- e:lessons|L345||legacy|open -->
**L345 · When two independent agents disagree about a number, fetch the source — do not pick the convenient one**
...
<!-- j2 tags=legacy-import refs= sha=b4624551d110c40b alias_of= -->
