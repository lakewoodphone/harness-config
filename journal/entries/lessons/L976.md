<!-- e:lessons|L976||legacy|open -->
**L976 · 2026-09-14 · The journal's `L`/`P` numbers are a shared namespace written by concurrent sessions, so claim the number at the moment of writing or lose a lesson to a collision**
...
<!-- j2 tags=legacy-import refs= sha=41c5957c6a075c7d alias_of= -->
