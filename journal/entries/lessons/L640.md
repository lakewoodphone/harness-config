<!-- e:lessons|L640||legacy|open -->
**L640 · When two independent agents disagree about a number, fetch the source — do not pick the convenient one**
...
<!-- j2 tags=legacy-import refs= sha=da79ed6888bda512 alias_of= -->
