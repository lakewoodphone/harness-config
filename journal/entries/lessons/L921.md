<!-- e:lessons|L921||legacy|open -->
**L921 · A column named `fetched_at` may record when a row was first SEEN, not when you last looked**
...
<!-- j2 tags=legacy-import refs= sha=f3b4dbcbd223dedd alias_of= -->
