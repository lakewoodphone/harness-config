<!-- e:lessons|L170||legacy|open -->
**L170 · 2026-09-11 · Working production code can exist outside version control, and only the *deployment host* knows it does.** The Shabbat/Tov split that fired at 18:46:53 tonight existed**
...
<!-- j2 tags=legacy-import refs= sha=91c0c3227f8e2a4d alias_of= -->
