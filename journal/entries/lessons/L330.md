<!-- e:lessons|L330||legacy|open -->
**L330 · `catch (Exception)` does not catch `Error`, and that is how a `compileOnly` dependency crashes an app**
...
<!-- j2 tags=legacy-import refs= sha=f8ce2dce0aaf2929 alias_of= -->
