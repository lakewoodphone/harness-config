<!-- e:lessons|L727||legacy|open -->
**L727 · In the DSH browser loader, a wrong dependency name breaks the whole UI, not the plugin**
...
<!-- j2 tags=legacy-import refs= sha=905cd33ff31b50b8 alias_of= -->
