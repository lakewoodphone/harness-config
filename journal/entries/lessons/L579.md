<!-- e:lessons|L579||legacy|open -->
**L579 · 2026-09-14 · `import.meta.main` silently no-ops the whole CLI on Node < 24.2 — and `node --check`, `import()`, and a clean exit code all say the code is fine**
...
<!-- j2 tags=legacy-import refs= sha=64046736dfffd757 alias_of= -->
