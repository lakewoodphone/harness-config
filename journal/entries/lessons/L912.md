<!-- e:lessons|L912||legacy|open -->
**L912 · A model's self-reported confidence is not a failure signal — never gate a fail-closed system on it**
...
<!-- j2 tags=legacy-import refs= sha=c495423192f6e3d8 alias_of= -->
