<!-- e:lessons|L543||legacy|open -->
**L543 · `timeout N cmd <<EOF` gives the heredoc to the command's STDIN, so the timeout waits on stdin**
...
<!-- j2 tags=legacy-import refs= sha=a64644c496deb3ac alias_of= -->
