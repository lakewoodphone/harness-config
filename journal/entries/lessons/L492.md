<!-- e:lessons|L492||legacy|open -->
**L492 · 2026-09-14 · A Techloq-class filter serves its block page with a SUCCESS status code, so a status check reads a block as a pass**
...
<!-- j2 tags=legacy-import refs= sha=bff0747f5c64825d alias_of= -->
