<!-- e:lessons|L836||legacy|open -->
**L836 · A column named `fetched_at` may record when a row was first SEEN, not when you last looked**
...
<!-- j2 tags=legacy-import refs= sha=762ea5b151f0d3d4 alias_of= -->
