<!-- e:lessons|L1030||legacy|open -->
**L1030 · `Process.HasExited` on a detached child can block for the child's whole lifetime**
...
<!-- j2 tags=legacy-import refs= sha=0a51543e2fb089af alias_of= -->
