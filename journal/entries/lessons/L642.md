<!-- e:lessons|L642||legacy|open -->
**L642 · In the DSH browser loader, a wrong dependency name breaks the whole UI, not the plugin**
...
<!-- j2 tags=legacy-import refs= sha=f419721404dc9591 alias_of= -->
