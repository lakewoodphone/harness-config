<!-- e:lessons|L358||legacy|open -->
**L358 · When a data source embeds its vendor's internals, the fix is a reader, not a warning**
...
<!-- j2 tags=legacy-import refs= sha=93fce6becee1ef72 alias_of= -->
