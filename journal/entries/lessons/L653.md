<!-- e:lessons|L653||legacy|open -->
**L653 · When a data source embeds its vendor's internals, the fix is a reader, not a warning**
...
<!-- j2 tags=legacy-import refs= sha=04ad3e4f26fbb207 alias_of= -->
