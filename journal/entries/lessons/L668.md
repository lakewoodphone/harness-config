<!-- e:lessons|L668||legacy|open -->
**L668 · 2026-09-11 · Working production code can exist outside version control, and only the *deployment host* knows it does.** The Shabbat/Tov split that fired at 18:46:53 tonight existed**
...
<!-- j2 tags=legacy-import refs= sha=28abca98da876fc9 alias_of= -->
