<!-- e:lessons|L203||legacy|open -->
**L203 · 2026-09-14 · The journal's `L`/`P` numbers are a shared namespace written by concurrent sessions, so claim the number at the moment of writing or lose a lesson to a collision**
...
<!-- j2 tags=legacy-import refs= sha=13c2deb58a26cd99 alias_of= -->
