<!-- e:lessons|L1045||legacy|open -->
**L1045 · 2026-09-11 · A 500 from your own API can be a write lock, and the client's retry budget must outlast the server's patience**
...
<!-- j2 tags=legacy-import refs= sha=c36469f95f486966 alias_of= -->
