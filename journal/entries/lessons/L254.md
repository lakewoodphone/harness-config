<!-- e:lessons|L254||legacy|open -->
**L254 · A fix verified through one entry point is not verified. Test the path the user actually takes**
...
<!-- j2 tags=legacy-import refs= sha=f7c425b0c9b2db25 alias_of= -->
