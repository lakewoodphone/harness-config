<!-- e:lessons|L979||legacy|open -->
**L979 · 2026-09-14 · An exemption implemented in the backend must be re-implemented in every surface that counts the same thing — or the surfaces will disagree, and the loudest one wins**
...
<!-- j2 tags=legacy-import refs= sha=1cfe5db852b58743 alias_of= -->
