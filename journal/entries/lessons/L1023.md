<!-- e:lessons|L1023||legacy|open -->
**L1023 · `$pid` is reserved and read-only, and PowerShell matches it case-insensitively**
...
<!-- j2 tags=legacy-import refs= sha=c89daada67c48520 alias_of= -->
