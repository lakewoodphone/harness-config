<!-- e:lessons|L901||legacy|open -->
**L901 · A test that passes before and after the fix has no teeth — check it against the broken revision**
...
<!-- j2 tags=legacy-import refs= sha=ab34f5753e5b4be7 alias_of= -->
