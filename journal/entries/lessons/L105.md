<!-- e:lessons|L105||legacy|open -->
**L105 · In the DSH browser loader, a wrong dependency name breaks the whole UI, not the plugin**
...
<!-- j2 tags=legacy-import refs= sha=edd7ee07ceae9b9e alias_of= -->
