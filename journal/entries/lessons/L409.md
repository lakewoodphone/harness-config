<!-- e:lessons|L409||legacy|open -->
**L409 · 2026-09-14 · An exemption implemented in the backend must be re-implemented in every surface that counts the same thing — or the surfaces will disagree, and the loudest one wins**
...
<!-- j2 tags=legacy-import refs= sha=471cac5bf8326377 alias_of= -->
