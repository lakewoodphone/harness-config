<!-- e:lessons|L118||legacy|open -->
**L118 · `timeout N cmd <<EOF` gives the heredoc to the command's STDIN, so the timeout waits on stdin**
...
<!-- j2 tags=legacy-import refs= sha=c88344602a2392ee alias_of= -->
