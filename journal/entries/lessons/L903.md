<!-- e:lessons|L903||legacy|open -->
**L903 · A log file that the child process owns cannot be cleared by the parent**
...
<!-- j2 tags=legacy-import refs= sha=eac9b3152caf764c alias_of= -->
