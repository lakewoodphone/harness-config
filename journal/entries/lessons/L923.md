<!-- e:lessons|L923||legacy|open -->
**L923 · `timeout N cmd <<EOF` gives the heredoc to the command's STDIN, so the timeout waits on stdin**
...
<!-- j2 tags=legacy-import refs= sha=3d32983c2e7da707 alias_of= -->
