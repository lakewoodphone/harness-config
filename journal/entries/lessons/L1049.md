<!-- e:lessons|L1049||legacy|open -->
**L1049 · 2026-09-11 · Measure the size of a lie before you fix it — and beware a metric that counts the *failure handler* as success**
...
<!-- j2 tags=legacy-import refs= sha=bd1075cf0d055d2f alias_of= -->
