<!-- e:lessons|L648||legacy|open -->
**L648 · `timeout N cmd <<EOF` gives the heredoc to the command's STDIN, so the timeout waits on stdin**
...
<!-- j2 tags=legacy-import refs= sha=4b468512305da7c8 alias_of= -->
