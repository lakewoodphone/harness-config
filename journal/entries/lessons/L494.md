<!-- e:lessons|L494||legacy|open -->
**L494 · 2026-09-14 · `import.meta.main` silently no-ops the whole CLI on Node < 24.2 — and `node --check`, `import()`, and a clean exit code all say the code is fine**
...
<!-- j2 tags=legacy-import refs= sha=ffe4cb74b62387f3 alias_of= -->
