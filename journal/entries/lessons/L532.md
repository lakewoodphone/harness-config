<!-- e:lessons|L532||legacy|open -->
**L532 · A model's self-reported confidence is not a failure signal — never gate a fail-closed system on it**
...
<!-- j2 tags=legacy-import refs= sha=ef931b1b98e17c20 alias_of= -->
