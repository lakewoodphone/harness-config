<!-- e:lessons|L723||legacy|open -->
**L723 · The cheapest technical option can be the one the vendor forbids — read the terms before the price**
...
<!-- j2 tags=legacy-import refs= sha=f58c226247333bab alias_of= -->
