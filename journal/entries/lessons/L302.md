<!-- e:lessons|L302||legacy|open -->
**L302 · 2026-09-14 · A Techloq-class filter serves its block page with a SUCCESS status code, so a status check reads a block as a pass**
...
<!-- j2 tags=legacy-import refs= sha=c0cb7d97aa3b93fc alias_of= -->
