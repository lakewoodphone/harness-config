<!-- e:lessons|L521||legacy|open -->
**L521 · A test that passes before and after the fix has no teeth — check it against the broken revision**
...
<!-- j2 tags=legacy-import refs= sha=be2ca263c1254158 alias_of= -->
