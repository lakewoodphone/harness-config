<!-- e:lessons|L725||legacy|open -->
**L725 · When two independent agents disagree about a number, fetch the source — do not pick the convenient one**
...
<!-- j2 tags=legacy-import refs= sha=1a8b3fae035dda37 alias_of= -->
