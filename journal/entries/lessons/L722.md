<!-- e:lessons|L722||legacy|open -->
**L722 · A model's self-reported confidence is not a failure signal — never gate a fail-closed system on it**
...
<!-- j2 tags=legacy-import refs= sha=c6dc442b79057695 alias_of= -->
