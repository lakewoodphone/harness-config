<!-- e:lessons|L625||legacy|open -->
**L625 · `catch (Exception)` does not catch `Error`, and that is how a `compileOnly` dependency crashes an app**
...
<!-- j2 tags=legacy-import refs= sha=09f06c5cd3ce2de6 alias_of= -->
