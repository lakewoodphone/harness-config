<!-- e:lessons|L720||legacy|open -->
**L720 · A number in an internal document is a claim, not a measurement — and an unmeasurable band is a warning sign**
...
<!-- j2 tags=legacy-import refs= sha=5b11e5996c9d8e0f alias_of= -->
