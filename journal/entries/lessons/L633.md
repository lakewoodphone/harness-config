<!-- e:lessons|L633||legacy|open -->
**L633 · A tracker row saying "waiting on the owner" is a claim, not evidence — check the decisions log before asking**
...
<!-- j2 tags=legacy-import refs= sha=1c841bed0db184fa alias_of= -->
