<!-- e:lessons|L246||legacy|open -->
**L246 · A test that passes before and after the fix has no teeth — check it against the broken revision**
...
<!-- j2 tags=legacy-import refs= sha=188d8e2ab06aa3fe alias_of= -->
