<!-- e:lessons|L445||legacy|open -->
**L445 · A number in an internal document is a claim, not a measurement — and an unmeasurable band is a warning sign**
...
<!-- j2 tags=legacy-import refs= sha=3d0a7a35767d0268 alias_of= -->
