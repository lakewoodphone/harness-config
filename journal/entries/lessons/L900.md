<!-- e:lessons|L900||legacy|open -->
**L900 · `catch (Exception)` does not catch `Error`, and that is how a `compileOnly` dependency crashes an app**
...
<!-- j2 tags=legacy-import refs= sha=c0f72cb09c4e41d7 alias_of= -->
