<!-- e:lessons|L53||legacy|open -->
**L53 · A log file that the child process owns cannot be cleared by the parent**
...
<!-- j2 tags=legacy-import refs= sha=a89eb5890a84d244 alias_of= -->
