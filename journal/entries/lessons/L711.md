<!-- e:lessons|L711||legacy|open -->
**L711 · A test that passes before and after the fix has no teeth — check it against the broken revision**
...
<!-- j2 tags=legacy-import refs= sha=12550b13fed5c71a alias_of= -->
