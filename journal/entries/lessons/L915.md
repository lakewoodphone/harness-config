<!-- e:lessons|L915||legacy|open -->
**L915 · When two independent agents disagree about a number, fetch the source — do not pick the convenient one**
...
<!-- j2 tags=legacy-import refs= sha=9c8bc92c88d2cd9a alias_of= -->
