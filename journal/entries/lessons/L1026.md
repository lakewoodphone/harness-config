<!-- e:lessons|L1026||legacy|open -->
**L1026 · A column named `fetched_at` may record when a row was first SEEN, not when you last looked**
...
<!-- j2 tags=legacy-import refs= sha=d2bebacb6b8ff16b alias_of= -->
