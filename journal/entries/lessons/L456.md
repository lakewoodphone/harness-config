<!-- e:lessons|L456||legacy|open -->
**L456 · A column named `fetched_at` may record when a row was first SEEN, not when you last looked**
...
<!-- j2 tags=legacy-import refs= sha=6e8622dcfae89a36 alias_of= -->
