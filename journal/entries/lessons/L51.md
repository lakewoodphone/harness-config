<!-- e:lessons|L51||legacy|open -->
**L51 · A test that passes before and after the fix has no teeth — check it against the broken revision**
...
<!-- j2 tags=legacy-import refs= sha=03759e4b2fe6504f alias_of= -->
