<!-- e:lessons|L626||legacy|open -->
**L626 · A test that passes before and after the fix has no teeth — check it against the broken revision**
...
<!-- j2 tags=legacy-import refs= sha=4833ed045216e46f alias_of= -->
