<!-- e:lessons|L50||legacy|open -->
**L50 · `catch (Exception)` does not catch `Error`, and that is how a `compileOnly` dependency crashes an app**
...
<!-- j2 tags=legacy-import refs= sha=5043fda37fff10af alias_of= -->
