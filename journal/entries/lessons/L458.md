<!-- e:lessons|L458||legacy|open -->
**L458 · `timeout N cmd <<EOF` gives the heredoc to the command's STDIN, so the timeout waits on stdin**
...
<!-- j2 tags=legacy-import refs= sha=37beb2a177292891 alias_of= -->
