<!-- e:lessons|L248||legacy|open -->
**L248 · A log file that the child process owns cannot be cleared by the parent**
...
<!-- j2 tags=legacy-import refs= sha=1221f9eecb0f28fa alias_of= -->
