<!-- e:lessons|L435||legacy|open -->
**L435 · `catch (Exception)` does not catch `Error`, and that is how a `compileOnly` dependency crashes an app**
...
<!-- j2 tags=legacy-import refs= sha=48ffb6bb9b3f62f6 alias_of= -->
