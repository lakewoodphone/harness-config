<!-- e:lessons|L650||legacy|open -->
**L650 · `Process.HasExited` on a detached child can block for the child's whole lifetime**
...
<!-- j2 tags=legacy-import refs= sha=3dad44d56b3e9a59 alias_of= -->
