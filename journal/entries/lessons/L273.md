<!-- e:lessons|L273||legacy|open -->
**L273 · When a data source embeds its vendor's internals, the fix is a reader, not a warning**
...
<!-- j2 tags=legacy-import refs= sha=afb863ce72b8ef40 alias_of= -->
