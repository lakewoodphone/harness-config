<!-- e:lessons|L463||legacy|open -->
**L463 · When a data source embeds its vendor's internals, the fix is a reader, not a warning**
...
<!-- j2 tags=legacy-import refs= sha=00d6c1cb3330a087 alias_of= -->
