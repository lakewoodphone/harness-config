<!-- e:lessons|L535||legacy|open -->
**L535 · When two independent agents disagree about a number, fetch the source — do not pick the convenient one**
...
<!-- j2 tags=legacy-import refs= sha=11869407190b8929 alias_of= -->
