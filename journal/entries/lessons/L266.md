<!-- e:lessons|L266||legacy|open -->
**L266 · A column named `fetched_at` may record when a row was first SEEN, not when you last looked**
...
<!-- j2 tags=legacy-import refs= sha=fe3cb66690c8d210 alias_of= -->
