<!-- e:lessons|L460||legacy|open -->
**L460 · `Process.HasExited` on a detached child can block for the child's whole lifetime**
...
<!-- j2 tags=legacy-import refs= sha=47dd22cedf23c649 alias_of= -->
