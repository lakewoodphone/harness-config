<!-- e:lessons|L263||legacy|open -->
**L263 · `$pid` is reserved and read-only, and PowerShell matches it case-insensitively**
...
<!-- j2 tags=legacy-import refs= sha=8920a7134f486aae alias_of= -->
