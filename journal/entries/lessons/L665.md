<!-- e:lessons|L665||legacy|open -->
**L665 · 2026-09-11 · A 500 from your own API can be a write lock, and the client's retry budget must outlast the server's patience**
...
<!-- j2 tags=legacy-import refs= sha=8e29fd6c33569ab8 alias_of= -->
