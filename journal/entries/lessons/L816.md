<!-- e:lessons|L816||legacy|open -->
**L816 · A test that passes before and after the fix has no teeth — check it against the broken revision**
...
<!-- j2 tags=legacy-import refs= sha=96a96f1be3b56579 alias_of= -->
