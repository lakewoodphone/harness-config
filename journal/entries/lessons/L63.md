<!-- e:lessons|L63||legacy|open -->
**L63 · The cheapest technical option can be the one the vendor forbids — read the terms before the price**
...
<!-- j2 tags=legacy-import refs= sha=9fe68c004167cd0b alias_of= -->
