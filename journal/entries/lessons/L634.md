<!-- e:lessons|L634||legacy|open -->
**L634 · A fix verified through one entry point is not verified. Test the path the user actually takes**
...
<!-- j2 tags=legacy-import refs= sha=0b3439c7b692213a alias_of= -->
