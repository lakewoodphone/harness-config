<!-- e:lessons|L786||legacy|open -->
**L786 · 2026-09-14 · The journal's `L`/`P` numbers are a shared namespace written by concurrent sessions, so claim the number at the moment of writing or lose a lesson to a collision**
...
<!-- j2 tags=legacy-import refs= sha=12d87d7fdd3f15ca alias_of= -->
