<!-- e:lessons|L406||legacy|open -->
**L406 · 2026-09-14 · The journal's `L`/`P` numbers are a shared namespace written by concurrent sessions, so claim the number at the moment of writing or lose a lesson to a collision**
...
<!-- j2 tags=legacy-import refs= sha=b9f704b7bf3c875e alias_of= -->
