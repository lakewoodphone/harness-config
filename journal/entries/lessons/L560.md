<!-- e:lessons|L560||legacy|open -->
**L560 · 2026-09-11 · A 500 from your own API can be a write lock, and the client's retry budget must outlast the server's patience**
...
<!-- j2 tags=legacy-import refs= sha=6de79a6c86345c5a alias_of= -->
