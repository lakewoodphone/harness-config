<!-- e:lessons|L343||legacy|open -->
**L343 · The cheapest technical option can be the one the vendor forbids — read the terms before the price**
...
<!-- j2 tags=legacy-import refs= sha=066cee2cdf2257ea alias_of= -->
