<!-- e:lessons|L638||legacy|open -->
**L638 · The cheapest technical option can be the one the vendor forbids — read the terms before the price**
...
<!-- j2 tags=legacy-import refs= sha=a6f4d72ed1a555ac alias_of= -->
