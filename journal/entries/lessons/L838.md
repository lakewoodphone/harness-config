<!-- e:lessons|L838||legacy|open -->
**L838 · `timeout N cmd <<EOF` gives the heredoc to the command's STDIN, so the timeout waits on stdin**
...
<!-- j2 tags=legacy-import refs= sha=36a0b0102b608188 alias_of= -->
