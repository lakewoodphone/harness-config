<!-- e:lessons|L750||legacy|open -->
**L750 · 2026-09-11 · A 500 from your own API can be a write lock, and the client's retry budget must outlast the server's patience**
...
<!-- j2 tags=legacy-import refs= sha=a942e29ce123ba7f alias_of= -->
