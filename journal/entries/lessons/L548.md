<!-- e:lessons|L548||legacy|open -->
**L548 · When a data source embeds its vendor's internals, the fix is a reader, not a warning**
...
<!-- j2 tags=legacy-import refs= sha=92f06373376fa8ec alias_of= -->
