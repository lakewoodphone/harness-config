<!-- e:lessons|L872||legacy|open -->
**L872 · 2026-09-14 · A Techloq-class filter serves its block page with a SUCCESS status code, so a status check reads a block as a pass**
...
<!-- j2 tags=legacy-import refs= sha=9e81b9876726ef82 alias_of= -->
