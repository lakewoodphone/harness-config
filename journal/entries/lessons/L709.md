<!-- e:lessons|L709||legacy|open -->
**L709 · A script that has never run against its real target is not a script**
...
<!-- j2 tags=legacy-import refs= sha=4a9e0e830d4a4752 alias_of= -->
