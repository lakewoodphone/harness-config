<!-- e:lessons|L735||legacy|open -->
**L735 · `Process.HasExited` on a detached child can block for the child's whole lifetime**
...
<!-- j2 tags=legacy-import refs= sha=78e7009aea7a996e alias_of= -->
