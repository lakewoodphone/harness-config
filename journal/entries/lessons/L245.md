<!-- e:lessons|L245||legacy|open -->
**L245 · `catch (Exception)` does not catch `Error`, and that is how a `compileOnly` dependency crashes an app**
...
<!-- j2 tags=legacy-import refs= sha=92a8a0e9f0efcb20 alias_of= -->
