<!-- e:lessons|L103||legacy|open -->
**L103 · When two independent agents disagree about a number, fetch the source — do not pick the convenient one**
...
<!-- j2 tags=legacy-import refs= sha=bb9741647d54db6b alias_of= -->
