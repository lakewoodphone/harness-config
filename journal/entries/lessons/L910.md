<!-- e:lessons|L910||legacy|open -->
**L910 · A number in an internal document is a claim, not a measurement — and an unmeasurable band is a warning sign**
...
<!-- j2 tags=legacy-import refs= sha=13a22cdfd3d049f7 alias_of= -->
