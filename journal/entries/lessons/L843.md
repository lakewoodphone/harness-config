<!-- e:lessons|L843||legacy|open -->
**L843 · When a data source embeds its vendor's internals, the fix is a reader, not a warning**
...
<!-- j2 tags=legacy-import refs= sha=4df5ac9c213ae93c alias_of= -->
