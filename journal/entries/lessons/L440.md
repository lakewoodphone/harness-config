<!-- e:lessons|L440||legacy|open -->
**L440 · A successful tool call is not a correct answer. Verify the claim, not the plumbing**
...
<!-- j2 tags=legacy-import refs= sha=ceb5e273d7afa3c2 alias_of= -->
