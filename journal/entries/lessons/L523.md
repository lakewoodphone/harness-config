<!-- e:lessons|L523||legacy|open -->
**L523 · A log file that the child process owns cannot be cleared by the parent**
...
<!-- j2 tags=legacy-import refs= sha=6ed9a50b00048ec5 alias_of= -->
