<!-- e:lessons|L448||legacy|open -->
**L448 · The cheapest technical option can be the one the vendor forbids — read the terms before the price**
...
<!-- j2 tags=legacy-import refs= sha=dca1e036934040dc alias_of= -->
