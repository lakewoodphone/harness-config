<!-- e:lessons|L351||legacy|open -->
**L351 · A column named `fetched_at` may record when a row was first SEEN, not when you last looked**
...
<!-- j2 tags=legacy-import refs= sha=9b4dede5cac3e5da alias_of= -->
