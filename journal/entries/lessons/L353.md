<!-- e:lessons|L353||legacy|open -->
**L353 · `timeout N cmd <<EOF` gives the heredoc to the command's STDIN, so the timeout waits on stdin**
...
<!-- j2 tags=legacy-import refs= sha=558021eaa95bff4b alias_of= -->
