<!-- e:lessons|L257||legacy|open -->
**L257 · A model's self-reported confidence is not a failure signal — never gate a fail-closed system on it**
...
<!-- j2 tags=legacy-import refs= sha=432485465601782d alias_of= -->
