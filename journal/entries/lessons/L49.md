<!-- e:lessons|L49||legacy|open -->
**L49 · A script that has never run against its real target is not a script**
...
<!-- j2 tags=legacy-import refs= sha=f85018bfc15cee04 alias_of= -->
