<!-- e:lessons|L387||legacy|open -->
**L387 · 2026-09-14 · A Techloq-class filter serves its block page with a SUCCESS status code, so a status check reads a block as a pass**
...
<!-- j2 tags=legacy-import refs= sha=155f0d2e30510b65 alias_of= -->
