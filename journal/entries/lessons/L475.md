<!-- e:lessons|L475||legacy|open -->
**L475 · 2026-09-11 · A 500 from your own API can be a write lock, and the client's retry budget must outlast the server's patience**
...
<!-- j2 tags=legacy-import refs= sha=e43ade380603f856 alias_of= -->
