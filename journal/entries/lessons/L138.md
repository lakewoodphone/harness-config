<!-- e:lessons|L138||legacy|open -->
**L138 · When a data source embeds its vendor's internals, the fix is a reader, not a warning**
...
<!-- j2 tags=legacy-import refs= sha=6bbcd7a1446d18d0 alias_of= -->
