<!-- e:lessons|L596||legacy|open -->
**L596 · 2026-09-14 · The journal's `L`/`P` numbers are a shared namespace written by concurrent sessions, so claim the number at the moment of writing or lose a lesson to a collision**
...
<!-- j2 tags=legacy-import refs= sha=a174d667f03595d7 alias_of= -->
