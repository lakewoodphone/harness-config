<!-- e:lessons|L116||legacy|open -->
**L116 · A column named `fetched_at` may record when a row was first SEEN, not when you last looked**
...
<!-- j2 tags=legacy-import refs= sha=49f7190875ed5231 alias_of= -->
