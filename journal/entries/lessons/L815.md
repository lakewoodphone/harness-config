<!-- e:lessons|L815||legacy|open -->
**L815 · `catch (Exception)` does not catch `Error`, and that is how a `compileOnly` dependency crashes an app**
...
<!-- j2 tags=legacy-import refs= sha=96a7a27b728cda60 alias_of= -->
