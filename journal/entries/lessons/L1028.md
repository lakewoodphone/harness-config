<!-- e:lessons|L1028||legacy|open -->
**L1028 · `timeout N cmd <<EOF` gives the heredoc to the command's STDIN, so the timeout waits on stdin**
...
<!-- j2 tags=legacy-import refs= sha=23088b763a53a358 alias_of= -->
