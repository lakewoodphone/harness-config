<!-- e:lessons|L537||legacy|open -->
**L537 · In the DSH browser loader, a wrong dependency name breaks the whole UI, not the plugin**
...
<!-- j2 tags=legacy-import refs= sha=a8d3afc29c83ca98 alias_of= -->
