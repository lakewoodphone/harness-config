<!-- e:lessons|L447||legacy|open -->
**L447 · A model's self-reported confidence is not a failure signal — never gate a fail-closed system on it**
...
<!-- j2 tags=legacy-import refs= sha=0885b4759c5eba2e alias_of= -->
